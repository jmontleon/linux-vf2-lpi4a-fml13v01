...
int inno_hdmi_config_video_avi(struct inno_hdmi *hdmi, const struct drm_display_mode *mode)
{
	struct drm_connector *connector = &hdmi->connector;
...
int inno_hdmi_config_video_timing(struct inno_hdmi *hdmi, const struct drm_display_mode *mode)
{
	int value;
